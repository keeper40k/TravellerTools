...
public class TravellerCharacter
{
    ...
    private const string LadyTitle = "Lady";
    private const string KnightTitle = "Knight";
    private const string KnightessTitle = "Knightess";
    private const string DameTitle = "Dame";
    private const string BaronTitle = "Baron";
    private const string BaronetTitle = "Baronet";
    private const string BaronessTitle = "Baroness";
    private const string MarquisTitle = "Marquis";
    private const string MarquesaTitle = "Marquesa";
    private const string MarchionessTitle = "Marchioness";
    private const string CountTitle = "Count";
    private const string ViscountTitle = "Viscount";
    private const string CountessTitle = "Countess";
    private const string DukeTitle = "Duke";
    private const string DuchessTitle = "Duchess";
    private const string ArchdukeTitle = "Archduke";
    private const string ArchduchessTitle = "Archduchess";
    private const string PrinceTitle = "Prince";
    private const string PrincessTitle = "Princess";
    private const string EmperorTitle = "Emperor";
    private const string EmperoressTitle = "Emperoress";

    private const string FailedAgingCrisis = "{0} suffered an Aging Crisis and passed away at the age of {1}.";
    private const string PassedAgingCrisis = "{0} passed through Aging Crisis at the age of {1} and aged a further {2} months due to Slow Drug recovery.";
    ...
    protected void Phase1AgeCheck(decimal currentAge)
    {
        ...
        {
            END = END - 1;
            CreationHistory += string.Format(CharacteristicOrSkillLossFormat, Name, 1, "END");
        }
    ...
    protected void Phase3AgeCheck(decimal currentAge)
    {
        ...
        {
            INT = INT - 1;
            CreationHistory += string.Format(CharacteristicOrSkillLossFormat, Name, 1, "INT");
        }
        AgingCrisis(currentAge);
    }
    ...
    public List<string> AvailableTitles()
    {
        ...
        switch (SOC)
        {
            case 11:
                {
                    titles.Add(KnightTitle);
                    titles.Add(KnightessTitle);
                    titles.Add(DameTitle);
                    titles.Add(SirTitle);
                    titles.Add(LadyTitle);
                    break;
                }
            case 12:
                {
                    titles.Add(BaronTitle);
                    titles.Add(BaronetTitle);
                    titles.Add(BaronessTitle);
                    break;
                }
            case 13:
                {
                    titles.Add(MarquisTitle);
                    titles.Add(MarquesaTitle);
                    titles.Add(MarchionessTitle);
                    break;
                }
            case 14:
                {
                    titles.Add(CountTitle);
                    titles.Add(ViscountTitle);
                    titles.Add(CountessTitle);
                    break;
                }
            case 15:
                {
                    titles.Add(DukeTitle);
                    titles.Add(DuchessTitle);
                    break;
                }
            case 16:
                {
                    titles.Add(ArchdukeTitle);
                    titles.Add(ArchduchessTitle);
                    titles.Add(PrinceTitle);
                    titles.Add(PrincessTitle);
                    break;
                }
            case 17:
                {
                    titles.Add(EmperorTitle);
                    titles.Add(EmperoressTitle);
                    break;
                }
            default:
                {
    ...
    // Retain the legacy exception type for callers that already handle it.
    ...
    public void AddGear(TravellerGear gear)
    {
        ...
        {
            throw new ArgumentOutOfRangeException(nameof(gear), "gear parameter cannot be null");
        }
    }
